var test1 = (function (exports) {
    ...
    function isApiResponseStored(strKey) {
        if (strKey &&
            strKey !== '' &&
            hasCustomProperty(exports._apiResponseStore, strKey) &&
            exports._apiResponseStore[strKey]) {
            return true;
        }
        return false;
    }
    function storeApiResponse(strKey, objResponse) {
        if (!exports._apiResponseStore) {
            exports._apiResponseStore = {};
        }
        exports._apiResponseStore[strKey] = objResponse;
        MFEController.setAppStoreCache(APP_ID, strKey, objResponse);
    }
    function destroyApi() {
        _ticketStore = null;
        _contactStore = null;
        exports._apiResponseStore = null;
    }
    ...
    async function fetchNativeObjects(config) {
        ...
        if (isApiResponseStored(strStoreKey)) {
            return exports._apiResponseStore[strStoreKey];
        }
    ...
    async function fetchEntity(config, id, force = false) {
        if (!force && isApiResponseStored(id)) {
            return exports._apiResponseStore[id];
        }
    ...
    async function fetchObjectAssociations(config, objectId) {
        ...
        for (let i1 = 0; i1 < intLength; i1++) {
            ...
            exports._apiResponseStore[objItem.id] = objItem;
        ...
        window.log(`store key ${strStoreKey}, <pre>${JSON.stringify(objResponse, null, 2)}</pre>`);
    ...
    const coAPISDK = (window.coAPISDK = window.coAPISDK || {
        get: getApi,
        destroy: destroyApi,
    });

    exports.bringPrimaryFieldOnTop = bringPrimaryFieldOnTop;
    exports.coAPISDK = coAPISDK;
    exports.deserializeContextRecordId = deserializeContextRecordId;
    exports.destroyApi = destroyApi;
    exports.fetchApiData = fetchApiData;
    exports.fetchContactDetails = fetchContactDetails;
    exports.fetchCustomisedWidgetFields = fetchCustomisedWidgetFields;
    exports.fetchEntity = fetchEntity;
    exports.fetchNativeObjects = fetchNativeObjects;
    exports.fetchObjectAssociations = fetchObjectAssociations;
    exports.getApi = getApi;
    exports.getContactApiBasePath = getContactApiBasePath;
    exports.getCouiApiBasePath = getCouiApiBasePath;
    exports.getCouiConfig = getCouiConfig;
    exports.getCouiRoutePrefix = getCouiRoutePrefix;
    exports.getFormattedDate = getFormattedDate;
    exports.getObjectId = getObjectId;
    exports.getPrimaryField = getPrimaryField;
    exports.getSelectedSearchRecord = getSelectedSearchRecord;
    exports.hasUpdateRecordPermission = hasUpdateRecordPermission;
    exports.isApiResponseStored = isApiResponseStored;
    exports.linkNewRecord = linkNewRecord;
    exports.resolveNativeFieldValue = resolveNativeFieldValue;
    exports.searchEntityRecords = searchEntityRecords;
    exports.serializeContextRecordId = serializeContextRecordId;
    exports.setCouiConfig = setCouiConfig;
